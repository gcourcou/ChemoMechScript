...
def script_data_stamp():
    ...
    script_data["average_number_of_sides_in_MF"] = store_average_number_of_sides_in_MF
    script_data["average_area_in_MF"] = store_average_area_in_MF
...
#store average number of sides in MF
store_average_number_of_sides_in_MF = []
store_average_area_in_MF = []

def data_collection(i, tyssue, cell_number, cell_number_in_strip, cell_number_in_strip_pa, cell_shape_in_strip_pa, tissue_area, MF_position, mech_timer, tissue_length,P_area, A_area, average_number_of_sides_in_MF, average_area_in_MF):
...
#    
    ...
    average_number_of_sides_in_MF.append(average_number_of_sides_in_MF_frame)
    average_area_in_MF.append(average_area_in_MF_frame)
...
def chemo_mech_iterator(
    ...
    **kwargs
    ...
    for i in range(0+steps_proliferation, steps+steps_proliferation):
        ...
        data_collection(i, sheet, store_cell_number, store_cell_number_in_strip, store_cell_number_in_strip_pa, store_cell_shape_in_strip_pa,  store_tissue_area, store_MF_position, store_mech_timer, store_tissue_length, store_P_area, store_A_area, store_average_number_of_sides_in_MF, store_average_area_in_MF)
