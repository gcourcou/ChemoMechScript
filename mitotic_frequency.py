...
def  mitotic_frequency_sum(dict_from_file,division_type="uniform",interval=3) :
...
def mitotic_number(dict_from_file, interval = 3):
    ...
    mitotic_number_list = []
    normalized_time_list_total = []
    mitotic_number_list_total = []
    ...
    print("mitotic number list total length is:")
    print(len(mitotic_number_list_total))
    print("normalized time list total length is:")
    print(len(normalized_time_list_total))
